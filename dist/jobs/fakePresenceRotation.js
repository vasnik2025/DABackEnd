...
exports.rotateFakePresence = rotateFakePresence;
exports.scheduleFakePresenceRotation = scheduleFakePresenceRotation;
...
async function rotateFakePresence() {
    ...
    fakeUserIds.forEach((userId, index) => {
        ...
        rotationRequest.input(paramUserId, db_1.sql.NVarChar(255), userId);
        rotationRequest.input(paramOnline, db_1.sql.Bit, onlineSet.has(userId) ? 1 : 0);
...
function scheduleFakePresenceRotation() {
