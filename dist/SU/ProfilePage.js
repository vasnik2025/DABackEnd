...
const PhotoGrid_1 = __importDefault(require("./components/PhotoGrid"));
const Modal_1 = __importDefault(require("./components/Modal"));
const EditUserDetailsModal_1 = __importDefault(require("./components/EditUserDetailsModal"));
const ChangePasswordModal_1 = __importDefault(require("./components/ChangePasswordModal"));
const MemberProfileModal_1 = __importDefault(require("./components/MemberProfileModal"));
const ViewMyPhotoModal_1 = __importDefault(require("./components/ViewMyPhotoModal"));
const ViewSharedPhotoModal_1 = __importDefault(require("./components/ViewSharedPhotoModal"));
const SendPhotoForm_1 = __importDefault(require("./components/SendPhotoForm"));
const NotificationPopover_1 = __importDefault(require("./components/NotificationPopover"));
const EmailVerificationModal_1 = __importDefault(require("./components/EmailVerificationModal"));
const SharedPhotosInboxModal_1 = __importDefault(require("./components/SharedPhotosInboxModal"));
const apiService_1 = require("../services/apiService");
const PencilIcon_1 = require("./components/icons/PencilIcon");
const UserCircleIcon_1 = require("./components/icons/UserCircleIcon");
const SearchIcon_1 = require("./components/icons/SearchIcon");
const CameraIcon_1 = require("./components/icons/CameraIcon");
const BellIcon_1 = require("./components/icons/BellIcon");
const ChatBubbleLeftRightIcon_1 = require("./components/icons/ChatBubbleLeftRightIcon");
const ViberIcon_1 = require("./components/icons/ViberIcon");
const WhatsAppIcon_1 = require("./components/icons/WhatsAppIcon");
const InstagramIcon_1 = require("./components/icons/InstagramIcon");
const FacebookIcon_1 = require("./components/icons/FacebookIcon");
const TeamsIcon_1 = require("./components/icons/TeamsIcon");
const MailIcon_1 = require("./components/icons/MailIcon");
const LockOpenIcon_1 = require("./components/icons/LockOpenIcon");
const LockClosedIcon_1 = require("./components/icons/LockClosedIcon");
const UploadIcon_1 = require("./components/icons/UploadIcon");
const HeartIcon_1 = require("./components/icons/HeartIcon");
...
const ProfilePage = () => {
    const { currentUser, updateUser, updateUserProfilePicture, reloadUser } = (0, useAuth_1.useAuth)();
    ...
    const [chatNotificationCount, setChatNotificationCount] = (0, react_1.useState)(0);
    const [isInboxModalOpen, setIsInboxModalOpen] = (0, react_1.useState)(false);
    ...
    const fetchAndCombineNotifications = (0, react_1.useCallback)(async () => {
        ...
        try {
            ...
            const chatNotifs = combined.filter(n => n.type === 'photo_share_request' || n.type === 'new_message');
    ...
    (0, react_1.useEffect)(() => {
        const handleClickOutside = (event) => {
            if (isNotificationPopoverOpen &&
                notificationPopoverRef.current && !notificationPopoverRef.current.contains(event.target) &&
    ...
    const handleEditBioClick = () => { setEditableBioText(currentUser?.bio ?? ''); setIsEditingBio(true); };
    ...
    const handleCancelEditBio = () => { setEditableBioText(currentUser?.bio ?? ''); setIsEditingBio(false); };
    ...
    const handleAcceptPhotoShare = async (share) => {
        ...
        try {
            const updatedShare = await (0, apiService_1.apiUpdatePhotoShareStatus)(share.id, 'accepted', currentUser.id);
            if (updatedShare) {
                setSelectedSharedPhotoItem(updatedShare);
                setIsViewSharedPhotoModalOpen(true);
            }
            else {
                throw new Error("API did not return updated share information.");
            }
        }
        catch (err) {
    ...
    const handleViewSharedPhotoFromInbox = (item) => {
    ...
    const handleConfirmSend = (0, react_1.useCallback)(async (recipientUsername, duration) => {
        ...
        const shareData = {
            ...
            sharedAt: '', // Will be generated by backend
            expiresAt: '', // Will be generated by backend
    ...
    return (react_1.default.createElement("div", { className: "container mx-auto p-4 sm:p-6 lg:p-8" },
        react_1.default.createElement("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-8" },
            react_1.default.createElement("div", { className: "xl:col-span-2 space-y-8" },
                react_1.default.createElement("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6" },
                    react_1.default.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8" },
                        react_1.default.createElement("div", { className: "space-y-6" },
                            react_1.default.createElement("div", { className: "flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-6" },
                                react_1.default.createElement("div", { className: "relative flex-shrink-0 group" },
                                    isProfilePicUpdating ? react_1.default.createElement("div", { className: "w-24 h-24 rounded-full bg-gray-200 animate-pulse" }) :
                                        currentUser?.profilePictureUrl ? react_1.default.createElement("img", { src: currentUser.profilePictureUrl, alt: "Profile", className: "w-24 h-24 rounded-full object-cover" }) : react_1.default.createElement(UserCircleIcon_1.UserCircleIcon, { className: "w-24 h-24 text-gray-400" }),
                                    react_1.default.createElement("button", { onClick: () => profilePictureInputRef.current?.click(), className: "absolute bottom-0 right-0 bg-gray-700 text-white p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity" },
                                        react_1.default.createElement(CameraIcon_1.CameraIcon, { className: "w-4 h-4" })),
                                    react_1.default.createElement("input", { type: "file", ref: profilePictureInputRef, onChange: handleProfilePictureChange, accept: "image/*", className: "hidden" })),
                                react_1.default.createElement("div", { className: "flex-grow" },
                                    react_1.default.createElement("h1", { className: "text-3xl font-bold text-accent-700 dark:text-accent-600 flex items-center justify-center sm:justify-start" },
                                        currentUser?.username,
                                        react_1.default.createElement("span", { className: `ml-2 w-3 h-3 rounded-full ${currentUser?.isOnline ? 'bg-green-500' : 'bg-gray-400'}`, title: currentUser?.isOnline ? 'Online' : 'Offline' })),
                                    react_1.default.createElement("div", { className: "mt-3 text-sm text-gray-600 dark:text-gray-400 space-y-1" },
                                        react_1.default.createElement("p", null,
                                            "Email: ",
                                            react_1.default.createElement("strong", { className: "font-semibold text-gray-800 dark:text-gray-200" }, currentUser?.email)),
                                        currentUser?.country && react_1.default.createElement("p", null,
                                            "Country: ",
                                            react_1.default.createElement("strong", { className: "font-semibold text-gray-800 dark:text-gray-200" }, currentUser.country)),
                                        currentUser?.city && react_1.default.createElement("p", null,
                                            "City: ",
                                            react_1.default.createElement("strong", { className: "font-semibold text-gray-800 dark:text-gray-200" }, currentUser.city)),
                                        react_1.default.createElement("p", null,
                                            "Membership: ",
                                            react_1.default.createElement("strong", { className: "font-semibold text-green-600 dark:text-green-400" }, getMembershipDisplay(currentUser)))),
                                    react_1.default.createElement("button", { onClick: handleToggleOnlineStatus, disabled: isBioUpdating, className: `mt-2 px-3 py-1.5 text-xs font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600` }, currentUser?.isOnline ? 'Go Offline' : 'Go Online'),
                                    !currentUser?.isEmailVerified && (react_1.default.createElement("button", { onClick: () => setIsVerificationModalOpen(true), className: `mt-2 ml-2 px-3 py-1.5 text-xs font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600` }, "Verify Email")))),
                            react_1.default.createElement("div", { className: "pt-6 border-t border-gray-200 dark:border-gray-700" },
                                react_1.default.createElement("h3", { className: "font-bold text-lg text-gray-700 dark:text-gray-200 mb-2" }, "Welcome Message"),
                                isEditingBio ? (react_1.default.createElement("div", { className: "animate-fade-in-down" },
                                    react_1.default.createElement("textarea", { value: editableBioText, onChange: handleBioTextChange, className: "w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 focus:ring-accent-500 focus:border-accent-500", rows: 4, placeholder: "Tell us about yourself...", "aria-label": "Edit your welcome message", disabled: isBioUpdating }),
                                    react_1.default.createElement("div", { className: "mt-2 flex justify-end space-x-2" },
                                        react_1.default.createElement("button", { onClick: handleCancelEditBio, disabled: isBioUpdating, className: "px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-md shadow-sm" }, "Cancel"),
                                        react_1.default.createElement("button", { onClick: handleSaveBio, disabled: isBioUpdating, className: "px-4 py-2 text-sm font-medium text-white bg-accent-600 hover:bg-accent-700 rounded-md shadow-sm" }, isBioUpdating ? "Saving..." : "Save Message")))) : (react_1.default.createElement("div", { className: "p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600 min-h-[100px]" },
                                    react_1.default.createElement("p", { className: "text-gray-700 dark:text-gray-300 whitespace-pre-wrap" }, currentUser?.bio || "No welcome message set."))))),
                        react_1.default.createElement("div", { className: "space-y-4 pt-0 md:pt-6 md:border-l md:pl-6 border-gray-200 dark:border-gray-700" },
                            react_1.default.createElement("div", { className: "flex justify-between items-center" },
                                react_1.default.createElement("h3", { className: "font-bold text-lg text-gray-700 dark:text-gray-200" }, "Social Links"),
                                !isEditingSocials &&
                                    react_1.default.createElement("button", { onClick: () => setIsEditingSocials(true), className: "inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500" },
                                        react_1.default.createElement(PencilIcon_1.PencilIcon, { className: "w-3 h-3 mr-1" }),
                                        " Edit")),
                            socialsError && !isEditingSocials && react_1.default.createElement("p", { className: "text-red-500 dark:text-red-400 text-sm text-center" }, socialsError),
                            isEditingSocials ? (react_1.default.createElement("div", { className: "space-y-4 animate-fade-in-down" },
                                socialsError && react_1.default.createElement("p", { className: "text-red-500 dark:text-red-400 text-sm text-center" }, socialsError),
                                socialLinksConfig.map(link => (react_1.default.createElement(SocialInput, { key: link.id, id: link.id, label: link.label, Icon: link.Icon, value: link.value, onValueChange: link.onValueChange, isPublic: link.isPublic, onIsPublicChange: link.onIsPublicChange, isSaving: isSocialsSaving }))),
                                react_1.default.createElement("div", { className: "flex justify-end space-x-2 pt-2" },
                                    react_1.default.createElement("button", { onClick: handleCancelEditSocials, disabled: isSocialsSaving, className: "px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-md shadow-sm" }, "Cancel"),
                                    react_1.default.createElement("button", { onClick: handleSaveSocials, disabled: isSocialsSaving, className: "px-4 py-2 text-sm font-medium text-white bg-accent-600 hover:bg-accent-700 rounded-md shadow-sm" }, isSocialsSaving ? "Saving..." : "Save Socials")))) : (react_1.default.createElement("div", { className: "space-y-1" }, socialLinksForDisplay.length > 0 ? (socialLinksForDisplay.map(link => (react_1.default.createElement(SocialLinkDisplay, { key: link.id, Icon: link.Icon, value: link.value, isPublic: !!link.isPublic, color: link.color })))) : (react_1.default.createElement("p", { className: "text-sm text-gray-500 dark:text-gray-400 italic px-2" }, "No public social links available.")))))),
                    react_1.default.createElement("div", { className: "mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-start gap-3" },
                        react_1.default.createElement("button", { onClick: handleEditBioClick, className: "inline-flex items-center whitespace-nowrap px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800" },
                            react_1.default.createElement(PencilIcon_1.PencilIcon, { className: "w-4 h-4 mr-1.5" }),
                            " Edit Welcome Message"),
                        react_1.default.createElement("button", { onClick: handleOpenEditDetailsModal, className: "inline-flex items-center whitespace-nowrap px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" },
                            react_1.default.createElement(PencilIcon_1.PencilIcon, { className: "w-4 h-4 mr-1.5" }),
                            " Edit Profile Details"),
                        react_1.default.createElement("button", { onClick: () => setIsInboxModalOpen(true), className: "relative inline-flex items-center whitespace-nowrap px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500 dark:focus:ring-offset-gray-800" },
                            react_1.default.createElement(ChatBubbleLeftRightIcon_1.ChatBubbleLeftRightIcon, { className: "w-4 h-4 mr-1.5" }),
                            " Inbox",
                            chatNotificationCount > 0 && (react_1.default.createElement("span", { className: "absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white ring-2 ring-white dark:ring-gray-800" }, chatNotificationCount > 9 ? '9+' : chatNotificationCount))),
                react_1.default.createElement("button", { onClick: handleOpenDonationModal, className: "inline-flex items-center whitespace-nowrap gap-1.5 px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500 dark:focus:ring-offset-gray-800" },
                    react_1.default.createElement(HeartIcon_1.HeartIcon, { className: "w-4 h-4" }),
                            " Donate"),
                        react_1.default.createElement("div", { className: "relative" },
                            react_1.default.createElement("button", { ref: notificationButtonRef, onClick: () => setIsNotificationPopoverOpen(p => !p), className: "relative inline-flex items-center p-2.5 border border-transparent rounded-full shadow-sm text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600" },
                                react_1.default.createElement(BellIcon_1.BellIcon, { className: "w-5 h-5" }),
                                unreadCount > 0 && react_1.default.createElement("span", { className: "absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white ring-2 ring-white dark:ring-gray-800" }, unreadCount > 9 ? "9+" : unreadCount)),
                            react_1.default.createElement(NotificationPopover_1.default, { isOpen: isNotificationPopoverOpen, notifications: allNotifications, isLoading: isLoadingNotifications, error: notificationError, onRefresh: fetchAndCombineNotifications, onClearAll: handleClearAllNotifications, renderItem: renderNotificationItem, popoverRef: notificationPopoverRef })))),
                react_1.default.createElement("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6" },
                    react_1.default.createElement("div", { className: "flex justify-between items-center mb-6" },
                        react_1.default.createElement("h2", { className: "text-2xl font-bold text-gray-800 dark:text-gray-200" }, "My Photos"),
                        react_1.default.createElement("button", { onClick: handleUploadButtonClick, disabled: isUploading, className: "inline-flex items-center text-accent-600 bg-gray-200 hover:bg-gray-300 dark:text-accent-400 dark:bg-gray-700 dark:hover:bg-gray-600 font-bold px-4 py-2 rounded-lg shadow-md transition duration-300 text-sm disabled:opacity-50" },
                            react_1.default.createElement(UploadIcon_1.UploadIcon, { className: "w-4 h-4 mr-2 inline" }),
                            isUploading ? "Uploading..." : "Upload New Photo")),
                    react_1.default.createElement("input", { type: "file", ref: uploadInputRef, onChange: handleFileSelected, className: "hidden", accept: "image/*", disabled: isUploading }),
                    isPhotosLoading ? react_1.default.createElement("p", null, "Loading photos...") : react_1.default.createElement(PhotoGrid_1.default, { photos: photos, onViewPhoto: handleViewPhoto, onDeletePhoto: handleDelete, onSendPhoto: handleSend, onTogglePhotoPublicStatus: handleTogglePublic }))),
            react_1.default.createElement("div", { className: "xl:col-span-1 space-y-6" },
                react_1.default.createElement("div", { ref: searchContainerRef, className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700 sticky top-6 z-20" },
                    react_1.default.createElement("h3", { className: "font-bold text-lg text-gray-700 dark:text-gray-200 mb-4" }, "Find Members"),
                    react_1.default.createElement("div", { className: "relative mb-2" },
                        react_1.default.createElement("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" },
                            react_1.default.createElement(SearchIcon_1.SearchIcon, { className: "h-5 w-5 text-gray-400 dark:text-gray-500" })),
                        react_1.default.createElement("input", { type: "search", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), placeholder: "Search members...", className: "block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 dark:focus:placeholder-gray-500 focus:ring-1 focus:ring-accent-500 focus:border-accent-500 sm:text-sm" })),
                    react_1.default.createElement("div", { className: "mt-3 space-y-2 sm:space-y-0 sm:flex sm:space-x-4 sm:flex-wrap" },
                        react_1.default.createElement("div", { className: "flex items-center basis-1/2 sm:basis-auto" },
                            react_1.default.createElement("input", { id: "filter-online", type: "checkbox", checked: filterOnlineOnly, onChange: (e) => setFilterOnlineOnly(e.target.checked), className: "h-4 w-4 text-accent-600 border-gray-300 dark:border-gray-600 rounded focus:ring-accent-500" }),
                            react_1.default.createElement("label", { htmlFor: "filter-online", className: "ml-2 text-sm text-gray-700 dark:text-gray-300" }, "Online Only")),
                        react_1.default.createElement("div", { className: "flex items-center basis-1/2 sm:basis-auto" },
                            react_1.default.createElement("input", { id: "filter-city-toggle", type: "checkbox", checked: filterByCity, onChange: (e) => setFilterByCity(e.target.checked), className: "h-4 w-4 text-accent-600 border-gray-300 dark:border-gray-600 rounded focus:ring-accent-500" }),
                            react_1.default.createElement("label", { htmlFor: "filter-city-toggle", className: "ml-2 text-sm text-gray-700 dark:text-gray-300" }, "Filter by City")),
                        filterByCity && react_1.default.createElement("input", { type: "text", value: cityFilterValue, onChange: e => setCityFilterValue(e.target.value), placeholder: "Enter city", className: "mt-2 sm:mt-0 block w-full sm:w-auto px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-accent-500 focus:border-accent-500" })),
                    react_1.default.createElement("div", { className: "mt-2" },
                        isSearching && searchResults.length > 0 && (react_1.default.createElement("div", { className: "grid grid-cols-3 gap-2 px-2 pb-2 border-b dark:border-gray-700 text-xs font-bold text-gray-500 dark:text-gray-400" },
                            react_1.default.createElement("div", { className: "truncate font-bold" }, "Username"),
                            react_1.default.createElement("div", { className: "truncate font-bold" }, "City"),
                            react_1.default.createElement("div", { className: "text-right truncate font-bold" }, "Last Active"))),
                        react_1.default.createElement("div", { className: "h-56 overflow-y-auto custom-scrollbar" }, isSearching && searchResults.length > 0 ? (react_1.default.createElement("ul", { className: "divide-y dark:divide-gray-700" }, searchResults.map(user => (react_1.default.createElement("li", { key: user.id, className: "py-2 px-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer grid grid-cols-3 gap-2 items-center text-sm", onClick: () => handleUserClick(user) },
                            react_1.default.createElement("span", { className: "flex items-center truncate text-gray-800 dark:text-gray-100" },
                                user.username,
                                user.isOnline && react_1.default.createElement("span", { className: "ml-2 w-2 h-2 bg-green-500 rounded-full", title: "Online" })),
                            react_1.default.createElement("span", { className: "truncate text-gray-600 dark:text-gray-400" }, user.city || 'N/A'),
                            react_1.default.createElement("span", { className: "truncate text-gray-500 dark:text-gray-400 text-right" }, user.updatedAt ? new Date(user.updatedAt).toLocaleDateString() : "N/A")))))) : isSearching ? (react_1.default.createElement("div", { className: "flex items-center justify-center h-full" },
                            react_1.default.createElement("p", { className: "text-sm text-gray-500 p-4 text-center" }, "No users found."))) : (react_1.default.createElement("div", { className: "flex items-center justify-center h-full" },
                            react_1.default.createElement("p", { className: "text-sm text-gray-500 p-4 text-center" }, "Start a search to find members.")))))),
                react_1.default.createElement("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sticky top-80" },
                    react_1.default.createElement("h3", { className: "font-bold text-lg mb-2" }, "New Members (Last 24h)"),
                    react_1.default.createElement("div", { className: "h-64 overflow-y-auto custom-scrollbar" }, newMembers.length > 0 ? (react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement("div", { className: "grid grid-cols-3 gap-2 px-2 pb-2 border-b dark:border-gray-700 text-xs font-bold text-gray-500 dark:text-gray-400" },
                            react_1.default.createElement("div", { className: "truncate font-bold" }, "Username"),
                            react_1.default.createElement("div", { className: "truncate font-bold" }, "City"),
                            react_1.default.createElement("div", { className: "text-right truncate font-bold" }, "Last Active")),
                        react_1.default.createElement("ul", { className: "divide-y dark:divide-gray-700 mt-1" }, newMembers.map(user => (react_1.default.createElement("li", { key: user.id, className: "py-2 px-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer grid grid-cols-3 gap-2 items-center text-sm", onClick: () => handleUserClick(user) },
                            react_1.default.createElement("span", { className: "flex items-center truncate text-gray-800 dark:text-gray-100" },
                                user.username,
                                user.isOnline && react_1.default.createElement("span", { className: "ml-2 w-2 h-2 bg-green-500 rounded-full", title: "Online" })),
                            react_1.default.createElement("span", { className: "truncate text-gray-600 dark:text-gray-400" }, user.city || 'N/A'),
                            react_1.default.createElement("span", { className: "truncate text-gray-500 dark:text-gray-400 text-right" }, formatLastActive(user)))))))) : (react_1.default.createElement("p", { className: "text-sm text-gray-500 p-4 text-center" }, "No new members in the last 24 hours.")))))),
        selectedPhotoForModal && (react_1.default.createElement(ViewMyPhotoModal_1.default, { isOpen: isViewPhotoModalOpen, onClose: handleCloseViewPhotoModal, photo: selectedPhotoForModal, onTogglePublic: handleTogglePublic, onDelete: handleDelete, onSend: handleSend, onReplace: handleReplace, onDeleteComment: handleDeleteComment, onDetailsReload: fetchUserPhotos })),
        isSendModalOpen && photoToSend && (react_1.default.createElement(Modal_1.default, { isOpen: isSendModalOpen, onClose: handleCloseSendModal, title: `Send "${photoToSend.caption || "Untitled Photo"}"` },
            react_1.default.createElement(SendPhotoForm_1.default, { photo: photoToSend, onConfirmSend: handleConfirmSend, onCancel: handleCloseSendModal, availableUsers: allUsers }))),
        currentUser && (react_1.default.createElement(EditUserDetailsModal_1.default, { isOpen: isEditDetailsModalOpen, onClose: () => setIsEditDetailsModalOpen(false), currentUser: currentUser, onSave: handleSaveUserDetails, onChangePasswordClick: handleOpenChangePasswordModal })),
        currentUser && (react_1.default.createElement(ChangePasswordModal_1.default, { isOpen: isChangePasswordModalOpen, onClose: () => setIsChangePasswordModalOpen(false), onSavePassword: handleSavePassword })),
        selectedUserForProfileModal && (react_1.default.createElement(MemberProfileModal_1.default, { isOpen: isMemberProfileModalOpen, onClose: () => { setIsMemberProfileModalOpen(false); setSelectedUserForProfileModal(null); }, user: selectedUserForProfileModal, onStartConversation: handleStartConversation })),
        currentUser && (react_1.default.createElement(SharedPhotosInboxModal_1.default, { isOpen: isInboxModalOpen, onClose: () => setIsInboxModalOpen(false), currentUser: currentUser, onViewSharedPhoto: handleViewSharedPhotoFromInbox, onRefreshNotifications: fetchAndCombineNotifications })),
        isViewSharedPhotoModalOpen && selectedSharedPhotoItem && (react_1.default.createElement(ViewSharedPhotoModal_1.default, { isOpen: isViewSharedPhotoModalOpen, onClose: (updatedStatus) => handleCloseViewSharedPhotoModal(selectedSharedPhotoItem.id, updatedStatus), sharedPhotoItem: selectedSharedPhotoItem })),
        currentUser && (react_1.default.createElement(EmailVerificationModal_1.default, { isOpen: isVerificationModalOpen, onClose: () => setIsVerificationModalOpen(false), currentUser: currentUser })),
        react_1.default.createElement(Modal_1.default, { isOpen: isDonationModalOpen, onClose: handleCloseDonationModal, title: donationState === 'form' ? "Support SwingerUnion.com" : "Thank You!" }, donationState === 'form' ? (react_1.default.createElement("div", { className: "text-center space-y-6 p-4" },
            react_1.default.createElement("img", { src: "/assets/img/SULogo.jpg", alt: "SwingerUnion Logo", className: "h-24 w-24 mx-auto rounded-full object-cover shadow-lg" }),
            react_1.default.createElement("p", { className: "text-lg text-gray-700 dark:text-gray-200" }, "Your support helps us keep the community running and ad-free."),
            react_1.default.createElement("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-4" }, "Thank you for your generosity!"),
            react_1.default.createElement("div", { className: "flex justify-center" },
                react_1.default.createElement("form", { action: "https://www.paypal.com/donate", method: "post", target: "_blank", onSubmit: handlePaypalSubmit },
                    react_1.default.createElement("input", { type: "hidden", name: "hosted_button_id", value: "HXEXRTZSZ2U94" }),
                    react_1.default.createElement("input", { type: "image", src: "https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif", name: "submit", title: "PayPal - The safer, easier way to pay online!", alt: "Donate with PayPal button" }),
                    react_1.default.createElement("img", { alt: "", src: "https://www.paypal.com/en_GR/i/scr/pixel.gif", width: "1", height: "1" }))))) : (react_1.default.createElement("div", { className: "text-center space-y-6 p-8" },
            react_1.default.createElement("h2", { className: "text-3xl font-bold text-accent-600" }, "Thank You!"),
            react_1.default.createElement("p", { className: "text-lg text-gray-700 dark:text-gray-200" }, "Your generosity is what keeps our community thriving. We appreciate your support!"),
            react_1.default.createElement("button", { onClick: handleCloseDonationModal, className: "mt-4 px-6 py-2 bg-accent-600 text-white rounded-md" }, "Close"))))));
};
