...
exports.proxyExternalImage = proxyExternalImage;
...
function respondWithError(res, req, status, message) {
    setCors(res, req);
    return res.status(status).json({ error: message });
}
async function proxyExternalImage(req, res) {
    ...
    try {
        ...
        const bodyStream = stream_1.Readable.fromWeb(upstream.body);
